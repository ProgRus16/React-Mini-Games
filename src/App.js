...
import { Wordle, Hangman, TicTacToe, Minesweeper, FifteenPuzzle, MadLibs, MemoryCards, Tetris, Maze, EngineeringCalculator } from './Games';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          {currentGame === 'EngineeringCalculator' && <EngineeringCalculator />}
